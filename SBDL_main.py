import sys
from AppLib import ConfigLoader, utils, DataLoader, Transformations
from AppLib.Logger import Log4j
from AppLib.DataLoader import *
import uuid
...
if __name__ == "__main__":
    ...
    address_df = DataLoader.read_addresses(spark, job_run_env, enable_hive, hive_db)
